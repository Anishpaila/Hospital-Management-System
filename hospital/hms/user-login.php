	...
	<body class="login">
		<div class="container-fluid" style="height: 100vh; display: flex; align-items: center;">
			<div class="row" style="width: 100%;">
				...
				<!-- Right: Patient Care Image -->
				<div class="col-xs-12 col-sm-6 col-md-6" style="display: flex; justify-content: center; align-items: center; padding: 20px; background: linear-gradient(135deg, #27ae60 0%, #229954 100%); min-height: 100vh;">
					<div style="text-align: center; color: white; width: 100%;">
						<img src="assets/images/patient copy.jpg" alt="Patient Care" style="width: 100%; max-width: 400px; height: auto; border-radius: 8px; box-shadow: 0 8px 32px rgba(0,0,0,0.2); margin-bottom: 20px;" onerror="this.style.display='none';">
						<h3 style="margin: 20px 0 10px 0; font-weight: 600; font-size: 28px;">Your Health Matters</h3>
						<p style="font-size: 16px; opacity: 0.9; padding: 0 20px;">Access your medical records and book appointments easily</p>
					</div>
				</div>
			</div>
		</div>
